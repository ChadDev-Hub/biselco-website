...
from ....modules.meters.model.meters import MeterAccount
from ....core.security import get_current_user
from sqlalchemy import select
from ....modules.meters.schema.requests_model import CreateMeterAccount
...
async def create_meter(
    ...
    try:
        ...
        new_meter = MeterAccount(
            account_no = form.account_number,
            user_id = user_id,
