...
const ComplaintsRouteButton = ({ svgfill, strokeColor, orientation }: Props) => {
    return (
        <Link href="/complaints" type='button' aria-label='Complaint Button Route' className={`is-drawer-close:tooltip w-full is-drawer-close:tooltip-right ${orientation} items-center lg:flex-row`} data-tip="Complaints">
            ...
            <span className="is-drawer-close:hidden dock-label">Complaints</span>
        </Link>
    )
}
