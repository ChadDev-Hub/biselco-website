...
const AlertComponent = ({children}: Props) => {
    ...
    return (
        ...
        {children}
         {alert.show && <div role="alert" className={`alert alert-${alert.alertType} z-100 absolute right-1/2 min-w-60 translate-x-1/2 top-20 text-sm md:text-md lg:text-md`}>
