...
const MessageModal = ({complaintData}: Props) => {
    ...
    useEffect(()=>{
        ...
        case "complaint_message":
            queueMicrotask(()=>{
                if (message.data.complaint_id !== complaintData.complaint_id) return
    ...
    },[message, complaintData.complaint_id])
    ...
    const onSubmit: SubmitHandler<FormType> = (data) => {
        ...
        sendMessage({detail:"complaint_message", ...complaintData, ...data});
        reset();
    }
    return (
        <>
            ...
            <dialog ref={modalRef} className='modal'>
                <div className='modal-box '>
                    ...
                    <div className='max-h-50 overflow-y-auto'>
                        ...
                        <div className={user?.id === m.sender_id ? "chat chat-end" : "chat chat-start"} key={index}>
