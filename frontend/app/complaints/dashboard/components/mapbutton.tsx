...
const MapButton = ({ location }: Props) => {
    ...
    return (
        <>
            <button aria-label='open-modal' data-tip= "View Map" type='button' onClick={handleOpenModal} className="btn btn-circle btn-ghost tooltip tooltip-right">
                <svg
                    width="64px"
                    height="64px"
                    ...
                    <g  id="SVGRepo_iconCarrier">
                        <path d="M786 279l-48-13 48-13 13-48 13 48 49 13-49 13-13 49-13-49zM834 332l-19-4 19-5 4-19 5 19 19 5-19 4-5 19-4-19z" fill="#FDCD60">
                        </path>
                        <path  d="M159 715l-21-5 21-5 5-21 5 21 21 5-21 5-5 21-5-21z" fill="#FDCD60">
                        </path>
                        <path d="M244 247m-9 0a9 9 0 1 0 18 0 9 9 0 1 0-18 0Z" fill="#5546CB">
                        </path>
                        <path d="M288 821l-27-6 27-7 6-27 7 27 27 7-27 6-7 27-6-27z" fill="#FDCD60">
                        </path>
                        ...
                        <path className='animate-bounce' d="M514 444c36-37 75-85 75-118a75 75 0 0 0-151 0c0 18 14 54 76 118z m-35-117a35 35 0 1 1 35 35 35 35 0 0 1-35-35z" fill="#F97744">
                        </path>
                        <path className='animate-bounce' d="M514 327m-35 0a35 35 0 1 0 70 0 35 35 0 1 0-70 0Z" fill="#FFFFFF">
                        </path>
                    </g>
                </svg>
