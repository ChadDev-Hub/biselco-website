...
const StatusHistoryModal = ({ data }: Props) => {
    ...
    return (
        <>
            <button title='Status History' type='button' onClick={handleOpen} data-tip="Status History" className='btn tooltip w-20 tooltip-top rounded-box flex flex-col items-center justify-center p-1 shadow-md border-gray-300'>
