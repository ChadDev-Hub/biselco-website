...
const StatusHistoryModal = ({ data }: Props) => {
    ...
    return (
        <>
            <button title='Status History' type='button' onClick={handleOpen} className='btn btn-circle btn-ghost'>
                <svg
                    className='h-7 w-7 drop-shadow-md drop-shadow-amber-600'
                    version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 484 484" fill="#000000"><g id="SVGRepo_bgCarrier"
                        strokeWidth="0">
                    </g>
                    ...
                    <g id="SVGRepo_iconCarrier">
                        <g>
                            <g>
                                ...
                                <g>
                                    <path
                                        d="M420.201,336.007c-1.397,0-2.817-0.294-4.17-0.916c-5.019-2.306-7.217-8.244-4.911-13.262 c11.395-24.793,17.172-51.315,17.172-78.829c0-35.76-10.031-70.57-29.01-100.666c-2.945-4.672-1.547-10.847,3.125-13.792 c4.672-2.948,10.846-1.547,13.793,3.125c20.994,33.294,32.092,71.793,32.092,111.334c0,30.417-6.392,59.749-18.999,87.18 C427.61,333.846,423.986,336.007,420.201,336.007z">
                                    </path>
                                </g>
                                <g>
                                    <path
                                        d="M375.29,107.724c-2.45,0-4.904-0.895-6.834-2.701c-13.866-12.987-29.525-23.772-46.542-32.057 c-4.966-2.418-7.031-8.403-4.614-13.369c2.417-4.965,8.403-7.031,13.368-4.614c18.817,9.162,36.131,21.086,51.46,35.442 c4.031,3.775,4.238,10.104,0.463,14.135C380.622,106.662,377.959,107.724,375.29,107.724z">
                                    </path>
                                </g>
                            </g>
                            <g>
            ...
            <dialog ref={modalRef} className='modal modal-bottom'>
                <div className='modal-box'>
                    ...
                    <h4 className='text-xl font-bold'>Status History</h4>
                    <div className='max-h-60 overflow-x-auto overflow-y-scroll'>
                        <table className='table table-xs'>
                            <thead className='text-sm font-bold z-20 text-center'>
                                <tr>
                                    <td>Status Change</td>
                                    <td>Updated By</td>
                                    <td>Date & Time</td>
                            ...
                            <tbody>
                                {
                                    data.map((item) => (
                                        <tr key={item.id} className='text-xs whitespace-nowrap'>
                                            <td className='items-center'><span className={`${statusIndicator(item.comments)} text-xs`}></span> {item.comments}</td>
                                            <td className='flex items-center justify-center'>
                                                <div title={item.first_name + " " + item.last_name} className="avatar avatar-placeholder tooltip hover:cursor-pointer tooltip-accent tooltip-bottom" data-tip={item.first_name + " " + item.last_name}>
                                                    <Image
                                                        loading="lazy"
                                                        width={20}
                                                        height={20}
