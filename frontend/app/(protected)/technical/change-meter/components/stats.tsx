      ...
      <div className="stats glass">
        {statistics.map((stat, index) => (
          <div key={index} className="stat shadow drop-shadow-md  drop-shadow-amber-600">
            ...
            <div className="stat-value text-center max-w-30">
              {stat.value}
            </div>
            <div className="stat-desc text-wrap text-xs italic">
              {stat.description}
            </div>
          </div>
        ))}
