      ...
      <div className="dropdown-content space-y-2 menu menu-compact bg-base-100 rounded-box z-1 w-52 p-2 shadow-sm">
        ...
        <div className="flex justify-between  gap-2">
          ...
          <select
            onChange={(e) => {
              router.push(
                `${pathname}?${buildParms("municipality", e.target.value, true, true)}`,
                { scroll: false },
              );
            }}
        ...
        <div className="flex justify-between  gap-2">
          ...
          <select
            onChange={(e) => {
              router.push(
                `${pathname}?${buildParms("is_verified", e.target.value === "verified" ? true : e.target.value === "unverified" ? false : "All", false, true)}`,
                { scroll: false },
              );
            }}
