...
const ComplaintsRouteButton = ({ svgfill, strokeColor, orientation }: Props) => {
    ...
    return (
        <button name='complaints' onClick={handleClick} type='button' aria-label='Complaint Button Route' className={`is-drawer-close:tooltip w-full is-drawer-close:tooltip-right ${orientation} items-center lg:flex-row`} data-tip="Complaints">
